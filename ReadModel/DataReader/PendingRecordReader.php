...
class PendingRecordReader
{
    ...
    public function getItem(Search\AbstractQcStatusRecordSearch $pendingStatusRecordSearch)
    {
        ...
        $select = $queryBuilder
            ...
            ->where(static::DB_COLUMN_APPROVAL_STATUS . ' = ?', \Base_Model_Catalog_Product::QC_STATUS_PENDING);
    ...
    {
        return $this->productQcStatusObjectFactory->createPendingFromArray($result);
    }
}
